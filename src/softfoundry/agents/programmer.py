...
async def run_programmer(
    ...
    async def _multi_session_worker(app: SoftFoundryApp) -> None:
        ...
        Creates fresh agents for each task.
        """
        task_number = 0
        ...
        while True:
            ...
            if task_number > 1:
                app.add_session_separator(f"Task #{task_number}")
            ...
            agent = ProgrammerAgent(
                ...
                project=project,
                epic=epic,
                resume=resume if task_number == 1 else False,
                new_session=new_session if task_number == 1 else True,
                verbosity=verbosity,
                max_iterations=max_iterations,
            )
            ...
            if exit_reason in ("task_complete", "no_tasks"):
                ...
                app.add_lifecycle_message(f"Next task in {task_delay}s...", "info")
